...
- `nn_ids_report.py` and timer/service units – Summarize alerts and log top offending IPs.
 - `threat_feed_blocklist.py` and timer/service units – Fetch threat feeds, block listed IP addresses, and log updates.
