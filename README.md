...
- **Neural Network IDS**: Optional scripts fetch GA Tech malware datasets and train a simple neural network model for intrusion detection.
...
- `setup_nn_ids.sh`, `nn_ids_setup.py` and `nn_ids_service.py` – Download datasets, train the neural network IDS, and monitor traffic.
