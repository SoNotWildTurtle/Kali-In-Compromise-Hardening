...
# Enable additional Defender protections and schedule regular scans
Set-MpPreference -DisableBehaviorMonitoring $false
Set-MpPreference -EnableNetworkProtection Enabled
Set-MpPreference -PUAProtection 1
$scanAction = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument 'Start-MpScan -ScanType FullScan'
$scanTrigger = New-ScheduledTaskTrigger -Daily -At 2am
Register-ScheduledTask -TaskName 'DailyFullMalwareScan' -Action $scanAction -Trigger $scanTrigger -Force
...
# Apply system-wide exploit mitigations
Set-ProcessMitigation -System -Enable DEP,ASLR,SEHOP,BottomUpASLR,HighEntropyASLR
...
# Disable LLMNR to reduce spoofing attacks
